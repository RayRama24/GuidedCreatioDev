namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalcAvgTicketProcessMethodsWrapper

	/// <exclude/>
	public class UsrCalcAvgTicketProcessMethodsWrapper : ProcessModel
	{

		public UsrCalcAvgTicketProcessMethodsWrapper(Process process)
			: base(process) {
		...
		private bool ScriptTask1Execute(ProcessExecutingContext context) {
			...
			var passengersCountColumn = esq.AddColumn("UsrPassengerCount");  // SELECT UsrPassengersCount as UsrPassengersCount, UsrPrice as UsrPrice FROM UsrYacht WHERE ...

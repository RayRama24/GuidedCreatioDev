	...
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					"type": "crt.Button",
					"caption": "#ResourceString(Button_rhm21fc_caption)#",
					"color": "default",
					"disabled": false,
					"size": "medium",
			...
			},
			{
				...
				"values": {
					...
					"clicked": {
						...
						"params": {
							"processName": "UsrCalcAvgTicketProcess",
							"processRunType": "ForTheSelectedPage",
							"saveAtProcessStart": true,
							"showNotification": true,
							"recordIdProcessParameterName": "YachIdParameter"
						}
					},
					"icon": "calculator-icon"
				},
				"parentName": "Button_rhm21fc",
		...
		handlers: /**SCHEMA_HANDLERS*/[
			...
			},
			{
				...
				handler: async (request, next) => {
					...
					var typeObject = await request.$context.PDS_UsrDriveType_xbbhfnk;
					var selectedDriveTypeId = "";
					if (typeObject) {
						selectedDriveTypeId = typeObject.value;
					}
					console.log("DriveTypeId: ", selectedDriveTypeId);
